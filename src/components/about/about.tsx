        ...
        <div className="about-right">
          ...
          <div className="about-me-text">
            <Typography variant="h5">
              {`Hello! I'm Subramanyam Kanithi, an experienced web developer with over a
          ...
          Angular JS, I ensure seamless and responsive user
          interfaces. On the backend, I excel in utilizing Node JS and Laravel
          to create robust and scalable server-side applications. With a
